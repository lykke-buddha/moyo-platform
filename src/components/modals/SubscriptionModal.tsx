                                        ...
                                        <>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-zinc-900 border border-zinc-700 focus:border-amber-500 rounded-xl p-3 text-white text-sm outline-none transition-all placeholder:text-zinc-600"
                                                />
                                            </div>
                                            <div className="flex gap-3">
                                                <div className="flex-1">
                                                    <label className="block text-xs text-zinc-400 mb-1.5 ml-1">Expiry</label>
                                                    <input
                                                        type="text"
                                                        placeholder="MM/YY"
                                                        className="w-full bg-zinc-900 border border-zinc-700 focus:border-amber-500 rounded-xl p-3 text-white text-sm outline-none transition-all placeholder:text-zinc-600"
                                                ...
                                                <div className="flex-1">
                                                    <label className="block text-xs text-zinc-400 mb-1.5 ml-1">CVC</label>
                                                    <input
                                                        type="text"
                                                        placeholder="123"
                                                        className="w-full bg-zinc-900 border border-zinc-700 focus:border-amber-500 rounded-xl p-3 text-white text-sm outline-none transition-all placeholder:text-zinc-600"
