...
export default function Sidebar() {
    ...
    const { isLoggedIn, logout, openLoginModal, user } = useAuth();
            ...
            <div className="p-4 border-t border-zinc-800/50 space-y-2">
                {isLoggedIn ? (
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-zinc-500 hover:text-amber-500 hover:bg-zinc-800/40 transition-all w-full justify-center lg:justify-start"
                    >
